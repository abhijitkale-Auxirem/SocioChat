      ...
      <section className="pt-32 pb-24">
        <div className="max-w-3xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-gray-400 mb-10">SocioChat is committed to full compliance with the General Data Protection Regulation (GDPR) and global data protection standards.</p>
          </motion.div>
          <div className="glass-dark rounded-3xl p-8 space-y-6">
            {[
              ...
              ['Data Transfers', 'Your data is stored primarily on secure servers worldwide. Any international transfers use standard contractual clauses.'],
            ...
            <div className="pt-4 border-t border-white/10">
              <p className="text-sm text-gray-400">For GDPR requests: <a href="mailto:privacy@sociochat.com" className="text-indigo-400 hover:underline">privacy@sociochat.com</a></p>
            </div>
          </div>
        </div>
      </section>
